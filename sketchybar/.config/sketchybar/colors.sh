...
export BAR_COLOR_TRANSPARENT=0x40000000
# export WORKSPACE_BG_FOCUSED=0x88FF00FF 
# export WORKSPACE_BG_UNFOCUSED=0x44FFFFFF 
export WORKSPACE_BG_FOCUSED=0x8841D1EA
export WORKSPACE_BG_UNFOCUSED=0x44FFFFFF 
